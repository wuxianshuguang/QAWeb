            ...
            '<div class="zh-add-question-form">',
                '<div class="div-section-big clearfix">',
                    '<div class="zg-form-text-input add-question-title-form" style="position: relative;">',
                        '<input type="text" class="js-title pop-input-editor  " placeholder="问题描述" style="height:22px;min-height:auto;"></textarea>',
                    '</div>',
                '</div>',
                '<div class="div-section-big">',
                    '<div class="add-question-section-title">详细信息：</div>',
                        ...
                        '<div class="zm-editable-editor-wrap no-toolbar">',
                            '<div class="zm-editable-editor-outer">',
                                '<div class="zm-editable-editor-field-wrap">',
                                    '<textarea class="js-content zm-editable-editor-field-element editable" placeholder="详细内容" style="font-style:italic;width:98%;"></textarea>',
                                '</div>',
                            '</div>',
                        '</div>',
                    '</div>',
